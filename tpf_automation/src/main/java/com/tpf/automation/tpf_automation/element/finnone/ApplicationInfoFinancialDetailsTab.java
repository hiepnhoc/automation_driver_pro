...
public class ApplicationInfoFinancialDetailsTab {
    ...
    public ApplicationInfoFinancialDetailsTab(WebDriver driver) {
        PageFactory.initElements(driver, this);
        this._driver = driver;
    }

    public void setIncomeDetailsData(List<FptIncomeDto> datas) throws JsonParseException, JsonMappingException, IOException {
        int index = 0;
        for (FptIncomeDto data : datas) {
