...
//        if (checkFormFamilyExpand) {
            ...
            SeleniumUtils.sendKeys(SeleniumUtils.findByID(driver,customerErrorResponse,"noOfDependents",stage,value),
                    noOfDependents);
            //SeleniumUtils.findByID(driver,customerErrorResponse,"noOfChildren",stage,value).sendKeys(noOfChildren);
            SeleniumUtils.sendKeys(SeleniumUtils.findByID(driver,customerErrorResponse,"noOfChildren",stage,value),
                    noOfChildren);
